...
####### PLOT THE RESULTS #######
filename = "dim_"+str(20)+"_pose_"+str(70)+"_gap_"+str(42)+"_2"
#filename = "dim_"+str(20)+"_"+str(25)+"_pose_"+str(70)+"_gap_"+str(34)+"_2" # rectangle (1st dim stick to right finger at the beginning of the manipulation
