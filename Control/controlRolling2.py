...
def singleAct(motor_object, torque_motor, traj, dt, forward, start_time, capture = cap, video_file = out):
...
def controlRolling(motor_L, motor_R, traj, capture = cap, video_file = out):
    ...
    list_pos_RL = singleAct(motor_R, motor_L, new_traj, dt, clockwise, start_manip, capture, video_file)
